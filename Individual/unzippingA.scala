...
object unzippingA {
  ...
  def fileDownload(url: String, fileName: String) = {
    new URL(url) #> new File("D:/Dowloads/Work/data/", fileName) !!
  }
  ...
  def extract2020(locations: Array[Array[String]]): Unit = {
    ...
    for (i <- locations) {
      ...
      var url = s"https://www2.census.gov/programs-surveys/decennial/2020/data/01-Redistricting_File--PL_94-171/${state}/${abbreviation}2020.pl.zip"

      fileDownload(url, "2020.zip")
      unzip("D:/Dowloads/Work/data/2020.zip")
