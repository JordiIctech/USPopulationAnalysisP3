...
object J_file {
  ...
  def outputcsv(foldername: String, name : String,newData:DataFrame): Unit =  {

    val outputfile = f"D:\\Downloads\\Work\\data\\testing\\$foldername" //Where the folder is located
